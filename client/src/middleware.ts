...
export function middleware(request: NextRequest) {
  ...
  console.log(isAccessingProtectedRoute, 'isAccessingProtectedRoute', pathname, token);
  ...
  const isAccessingPublicOnlyRoute = publicOnlyRoutes.some(path => pathname.startsWith(path));
